...
/*
 * Here is an example program that illustrates the use of the strided_range_iterator.
 * It is taken from thrust's examples.
...
int main(void)
{
  ...
  // It works by copying elements to the output stream with a " " between them - Erich
